                  ...
                  <div class="flex-1">
                    ...
                    <div class="bg-gray-50 px-4 py-6 sm:px-6">
                      <div class="flex items-start justify-between space-x-3">
                        <div class="space-y-1">
                          <DialogTitle class="text-base font-semibold leading-6 text-gray-900">Add delay.</DialogTitle>
...
export default {
  ...
  mounted() {
    if (this.selectedFlowEvent) {
      this.duration = this.selectedFlowEvent.delay;
      this.unit = this.selectedFlowEvent.delay_unit;
    }
  },
  methods: {
    addEvent() {
  ...
  watch: {
    selectedFlowEvent(newVal) {
      if (newVal) {
        this.duration = newVal.delay;
        this.unit = newVal.delay_unit;
      } else {
        this.duration = 0;
        this.unit = 'seconds';
      }
